...
--         print(idx)
  ...
  if ffi.os == 'OSX' then
   ...
   local extensionList = {'jpg', 'png','JPG','PNG','JPEG', 'ppm', 'PPM', 'bmp', 'BMP', 'mat'}
...
local function tableToOutput(self, dataTable, scalarTable)
  ...
  if opt.test == 1 and (opt.resize_or_crop == 'crop' or opt.resize_or_crop == 'scale_width' or opt.resize_or_crop == 'scale_height') then
