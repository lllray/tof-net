# # training code
 DATA_ROOT=/media/lixin/7A255A482B58BC84/lx/itof_datasets/torch_data niter=50 save_epoch_freq=5 mat=1 input_nc=5 output_nc=1 \
 	model=pix2pix align_data=1 name=filter_train which_model_netG=my_resnet_lite which_model_netD=my_imageGAN_128 \
 	use_GAN=1 lambda_A=10 norm=none continue_train=0\
