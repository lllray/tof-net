# # training code
 DATA_ROOT=~/bag/tintin_EE367/my_data/dataset-0421-3 niter=50 save_epoch_freq=40 mat=1 input_nc=5 output_nc=1 \
 	model=pix2pix align_data=1 name=my_data_my_resnet_lite_my_imageGAN_128 which_model_netG=my_resnet_lite which_model_netD=my_imageGAN_128 \
 	use_GAN=0 lambda_A=10 norm=none \
