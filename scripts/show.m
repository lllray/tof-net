...
type = 'real_B'; % fake_B,real_A,real_B,sra
if data_type == 1
mydata = '1110';
take = 5;
% mydata = '0926';
...
elseif data_type == 2
    load(sprintf('~/ROS/DeepEnd2End/DeepToF_release_0.1/src/GAN/results/my_resnet_lite_my_imageGAN_128_pretrained/latest_test/images/%s/%s_pix2pix_test_real_0.mat',type,mydata)) %results are stored as .mat files under [results_folder]/fake_B
...
elseif data_type == 2
    ...
    pointCloud_this = my_depthToPointCloud(result);
    figure(2);
